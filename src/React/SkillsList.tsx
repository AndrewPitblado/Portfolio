...
const CategoryIcons = {
  "Web Development": (
    <svg
      ...
      viewBox="0 0 24 24"
      fill="currentColor"
      className="h-6 w-6 text-[var(--sec)] opacity-70"
    >
...
const SkillsList = () => {
  ...
  return (
    <div className="pt-3 text-left md:pt-9">
      <h3 className="text-3xl font-semibold text-[var(--white)] md:mb-6 md:text-4xl">
        What I do?
      </h3>
        ...
        {Object.entries(skills).map(([category, items]) => (
          <li key={category} className="w-full">
            <div
              ...
              className="w-full cursor-pointer overflow-hidden rounded-2xl border border-[var(--white-icon-tr)] bg-[#1414149c] text-left transition-all hover:bg-[#141414]/80 md:w-[400px]"
            >
              <div className="flex items-center gap-3 p-4">
                ...
                <div className="flex flex-grow items-center justify-between gap-2">
                  ...
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className={`h-6 w-6 flex-shrink-0 text-[var(--white)] transition-transform ${
